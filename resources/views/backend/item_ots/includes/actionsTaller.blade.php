...
<div class="btn-group btn-group-sm" role="group" aria-label="@lang('labels.backend.access.users.user_actions')">
        ...
        <a href="{{ route('admin.orden_trabajos.printTallerOp',$trabajo) }}" target="_blank" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Imprimir OT Asociada">
