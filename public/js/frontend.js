  ...
  function() {
    ...
    return _c("div", { staticClass: "card" }, [
      _c("div", { staticClass: "card-header" }, [
        ...
        _vm._v(" Example Vue Componentttttttttttttttttt\n    ")
      ]),
      _vm._v(" "),
...
vue__WEBPACK_IMPORTED_MODULE_1___default.a.component('example-component', __webpack_require__(/*! ./components/ExampleComponent.vue */ "./resources/js/frontend/components/ExampleComponent.vue")["default"]);
/**
...
$(function () {
  ...
  */
  ...
  $('body').on('submit', 'form[name=send_item]', function (e) {
    e.preventDefault();
    var form = this;
    var link = $('a[data-method="send"]');
    var cancel = link.attr('data-trans-button-cancel') ? link.attr('data-trans-button-cancel') : 'Cancelar';
    var confirm = link.attr('data-trans-button-confirm') ? link.attr('data-trans-button-confirm') : 'Sí, Enviar';
    var title = link.attr('data-trans-title') ? link.attr('data-trans-title') : '¿ Está seguro de enviar este email?';
    Swal.fire({
      title: title,
      showCancelButton: true,
      confirmButtonText: confirm,
