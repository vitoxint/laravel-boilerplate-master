...
Route::group(['namespace' => 'ItemCotizacion'], function () {
    ...
    Route::post('item_cotizacions/destroy', [ItemCotizacionController::class, 'destroy'])->name('item_cotizacions.destroy');
    Route::post('item_cotizacion/update', [ItemCotizacionController::class, 'update'])->name('item_cotizacions.update');
...
Route::group(['namespace' => 'EtapaItemOt'], function () {
       ...
       Route::get('etapa-exportarxls', [EtapaItemOtController::class, 'exportarxls'])->name('etapa_itemots.exportarxls');
        ...
        Route::group(['prefix' => 'etapa_itemots/{etapaItemOt}'], function () {
           ...
           Route::get('pausar',   [EtapaItemOtController::class, 'pausar'])->name('etapa_itemots.pausar');
           ...
           Route::get('pausar_taller',   [EtapaItemOtController::class, 'pausarTaller'])->name('etapa_itemots.pausarTaller');
       }); 
